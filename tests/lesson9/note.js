...
const phoneNum = function (number) {
  return number;
};
...
const greetF = function (callback1, callback2) {
  console.log(
    "Hello " + callback1("Maks. ") + "Your number is " + callback2("0970595667!")
  );
};

let okF = function () {
  console.log('If you wanna know your status, choose "Ok"');
};
...
let security = function () {
  ...
  if (userStatus == "Ok") {
    ...
    console.log("Thank you for your appeal");
  }
};

greetF(nameF,phoneNum);
okF();
security();
